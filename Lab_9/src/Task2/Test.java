...
public class Test {
	public static void main(String[] args) {
		...
		SachKhamKhao s1 = new SachKhamKhao("Sach kham kho 3", 60, 2000, "A", 100, "Thể thao");
		SachKhamKhao s2 = new SachKhamKhao("Sach kham kho 2", 70, 2023, "D", 170, "Giáo dục");
		SachKhamKhao s3 = new SachKhamKhao("Sach kham kho 1", 300, 2020, "F", 300, "Y tế");
		...
		System.out.println("t1 là loại: "+t1.xacDinhLoaiAnPham());
		System.out.println("s1 là loại: "+s1.xacDinhLoaiAnPham()+ "\n");
		
		System.out.println("7) Phương thức kiểm tra ấn phẩm là tạp chí và có thời gian xuất bản cách đây \r\n"
				+ "(2021) 10 năm hay không:");
		System.out.println("Kiểm tra tạp chí t1: "+anPham.kiemTraTapChiSanXuat(t1, 2021));
		System.out.println("Kiểm tra tạp chí t2: "+anPham.kiemTraTapChiSanXuat(t2, 2021) + "\n");
		...
		System.out.println("11) Tìm xem trong danh sách các ấn phẩm có chứa một tạp chí có tên cho trước \r\n"
				+ "hay không?");
